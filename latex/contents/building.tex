...
En las figuras \ref{fig:fuselage} a \ref{fig:htail} se proporcionan los planos acotados del fuselaje, ala, cola vertical y cola horizontal del modelo. En la \rfig{model} se pueden identificar cada una de las partes en el modelo. 

\mfig{model}{pdf}{90}{ht}{Modelo a escala simplificado}
